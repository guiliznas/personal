...
const InstagramLogo = () => {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" className="ml-1">
      <path
        className="fill-[#E4405F] dark:fill-zinc-200"
...
const externalLinks: Link[] = [
  {
    ...
    url: "https://www.linkedin.com/in/guilherme-de-liz-do-nascimento-69213047/",
    icon: <SiLinkedin className="fill-[#0077B5] dark:fill-zinc-200" />,
  },
  {
    name: "GitHub",
    description: "steal my code",
    url: "https://github.com/guiliznas",
    icon: <SiGithub />,
  },
  {
    name: "Instagram",
    description: "see my photos",
    url: "https://instagram.com/guiliznas",
    icon: <InstagramLogo />,
  },
];
...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="hidden">
        Brazil-based developer passionate about building impactful tech
        solutions. I’ve been leading and developing full-stack web apps for over
        6 years, focusing on Python, Vue.js, and smart automations. Driven by
        faith, family, and the mission to create better opportunities for those
        I love. I enjoy terminal workflows, leading dev teams, and solving
        real-world problems with purpose and productivity.
      </p>
      <p className="text-sm">
        Brazilian, building software and leading development teams for over
        seven years. I currently split my time between the roles of Partner and
        hands-on developer. I love Python, Vue.js, optimizing team workflows,
        and tinkering with my home lab.
      </p>
      ...
      <div className="flex justify-center gap-6 max-sm:flex-col-reverse sm:justify-between">
        ...
        <div className="flex flex-col gap-2">
          <a
            href="/cv.pdf"
            download="Guilherme-Nascimento-CV.pdf"
